DROP TABLE IF EXISTS _SHOPPING_CART_LINE CASCADE;
DROP TABLE IF EXISTS _INDIVIDUAL CASCADE;
...
CREATE TABLE _INDIVIDUAL (
  _IND_ID   INT         NOT NULL,
  _IND_NAME VARCHAR(32) DEFAULT NULL,
  _IND_C_ID INT         NOT NULL,
  _IND_D_ID INT         NOT NULL,
  _IND_W_ID INT         NOT NULL,
  PRIMARY KEY (_IND_W_ID, _IND_D_ID, _IND_C_ID, _IND_ID),
  CONSTRAINT _IND_FKEY_C FOREIGN KEY (_IND_W_ID, _IND_D_ID, _IND_C_ID) 
    REFERENCES CUSTOMER (C_W_ID, C_D_ID, C_ID)
);

ALTER TABLE CUSTOMER 
  ADD COLUMN _C_IND_ID INT,
  ADD CONSTRAINT _C_FKEY_IND FOREIGN KEY (C_W_ID, C_D_ID, C_ID, _C_IND_ID) 
    REFERENCES _INDIVIDUAL (_IND_W_ID, _IND_D_ID, _IND_C_ID, _IND_ID);

CREATE TABLE _SHOPPING_CART_LINE (
  _SCL_C_ID         INT             NOT NULL,
  _SCL_D_ID         INT             NOT NULL,
  _SCL_W_ID         INT             NOT NULL,
  _SCL_NUMBER       INT             NOT NULL,
  _SCL_I_ID         INT             DEFAULT NULL,
  _SCL_SUPPLY_W_ID  INT             DEFAULT NULL,
  _SCL_DELIVERY_D   TIMESTAMP       DEFAULT NULL,
  _SCL_QUANTITY     INT             DEFAULT NULL,
  _SCL_AMOUNT       DECIMAL(6, 2)   DEFAULT NULL,
  _SCL_DIST_INFO    CHAR(24)        DEFAULT NULL,
  PRIMARY KEY (_SCL_W_ID, _SCL_D_ID, _SCL_C_ID, _SCL_NUMBER),
  CONSTRAINT _SCL_FKEY_S FOREIGN KEY (_SCL_I_ID, _SCL_SUPPLY_W_ID) 
